...
# Cleaning
clean:
	rm -rf src/*.bak INPUT/*.bak iteration* Error/ NonFatalError* ModelError* *.mod *.o *.bak
	clear
cleanall:
	rm -rf src/*.bak INPUT/*.bak iteration* Error/ NonFatalError* ModelError* *.mod *.o *.bak lib/  lib_DB/  lib_OPT/ FatalError* *.exe *.py
	clear
